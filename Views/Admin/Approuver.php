...
<head>
    ...
    <title>Approuver une nouvelle recette</title>
</head>
...
<body>
        ...
        <div id="table-super-container">
            <div id="table-container">
                <div id="toolbar">
                    ...
                    <button id="approuve" class="btn btn-dark">Approuver</button>
                    <button id="refresh" class="btn btn-primary">Refresh</button>
                </div>
                <table id="table" data-detail-view="true" data-detail-formatter="detailFormatter" data-height="600" data-show-columns="true" data-toolbar="#toolbar" data-toggle="table" data-search="true" data-click-to-select="true" data-auto-refresh="true" data-pagination="true" data-url="json/data3.json">
                    <thead>
                        <tr>
    ...
    <script src="./js/g-approuver.js"></script>
