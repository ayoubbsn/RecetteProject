...
<body>
    ...
    <div id="table-super-container">
        <div id="table-container">
            ...
            <table id="table" data-detail-view="true" data-detail-formatter="detailFormatter" data-height="600" data-show-columns="true" data-toolbar="#toolbar" data-toggle="table" data-search="true" data-click-to-select="true" data-auto-refresh="true" data-pagination="true" data-url="json/dataUserNa.json">
                <thead>
                    <tr>
    ...
    <script src="./js/UserApprv.js"></script>
</body>
